    ...
    <div className="py-20 container mx-auto p-4 max-w-5xl mb-6">
      ...
      <div className="flex-1">
          <p>
            ...
            park, or shop to recommend? You can check our website for more details!
          </p>
        </div>
      <h2 className="text-2xl font-semibold mb-6 text-blue-700 border-b-2 border-blue-200 pb-2 mt-4">
      ...
      <p className="text-center text-lg mt-10 text-gray-700">
        This guide is updated regularly with help from the community
      </p>
